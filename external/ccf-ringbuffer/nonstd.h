...
namespace nonstd
{
  ...
  split_1(const std::string_view& s, const std::string_view& separator)
  {
  ...
  remove_prefix(const std::string& s, const std::string& prefix)
  {
  ...
  static inline std::string
  remove_suffix(const std::string& s, const std::string& suffix)
  {
